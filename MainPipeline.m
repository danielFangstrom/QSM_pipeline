% This script takes inputs (subjects to process, relevant directories, and
% the opportunity to change parameter values and loop over them) and sends
% them to Sepia (so it is to a large extent a wrapper).
